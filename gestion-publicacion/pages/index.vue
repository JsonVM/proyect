...
<div class="container" id="container">
  <div class="form-container sign-in-container">
        <b-form ref="formularioLogin">
          ...
          <button color="primary" class="text-none" @click="login()">Ingresar</button>
  ...
  <div class="overlay-container">
		<div class="overlay">
				...
				<h1>Hola!</h1>
				<p>Ingresa tus datos personales como autor para empezar a publicar con nosotros!</p>
				<button class="ghost" id="signUp" onclick="window.location.href='info-publicacion'">Registrarse</button>
			</div>
		</div>
	</div>
